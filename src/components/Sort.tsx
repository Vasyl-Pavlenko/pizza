...
import { PopupClick, SortItem } from '../@types/types';
...
export const sortList: SortItem[] = [
  ...
  { name: 'Lowest Rated', sortProperty: SortPropertyEnum.RATING_ASC },
  ...
  { name: 'Z-A', sortProperty: SortPropertyEnum.TITLE_DESC },
];
